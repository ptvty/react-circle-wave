...
import { CircleWave, CircleWaveProps } from '../CircleWave';

/**
 * Pass any other component as children to view them over the circle
 */
export const CircleWaveWithChildren = ({...props}: CircleWaveProps) => {
    return (
        <CircleWave {...props}>
